...
podman run \
    ...
    --detach \
    --publish=80:80 \
    docker.io/bluegitter/documentserver-unlimited
```
...
docker run \
    ...
    --detach \
    --publish=80:80 \
    bluegitter/documentserver-unlimited
```
...
services:
  onlyoffice:
    ...
    image: bluegitter/documentserver-unlimited
    ports:
      - "80:80"
```
...
services:
  onlyoffice:
    container_name: onlyoffice
    image: documentserver-unlimited
    build:
